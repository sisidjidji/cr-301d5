...
function displayPics(){
  ...
  //The variable rando is declared inside a function displayPics the consol.log of rondo is outside of the function which return an erreur . const doesn’t allow its variable value to be accessed outside the enclosed block.
  console.log(viewed);
